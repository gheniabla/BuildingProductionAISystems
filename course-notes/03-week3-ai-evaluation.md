...
flowchart TB
    ...
    subgraph spectrum ["THE QUALITY SPECTRUM"]
        direction LR
        WRONG["WRONG<br/>#40;Easy to detect#41;"]
        FI["Factually<br/>incorrect"]
        PC["Partially<br/>correct"]
        CPW["Correct but<br/>poorly worded"]
        GE["Good<br/>enough"]
        PERFECT["PERFECT<br/>#40;Hard to define#41;"]
